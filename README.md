...
이 데모 프로젝트의 Figma 토큰 추출 기능을 **실제 프로젝트에 적용**하는 방법을 알고 싶으신가요?

👉 **[Figma → 프로젝트 통합 완전 가이드](./FIGMA_INTEGRATION_GUIDE.md)** 를 확인하세요!

### 가이드 주요 내용:
- ✅ Figma API 설정부터 실전 적용까지 A-Z
- ✅ React, Next.js, Vue, React Native 등 모든 프레임워크 대응
- ✅ 자동화 설정 (GitHub Actions, Vercel, Figma Webhook)
- ✅ 실전 E-commerce 프로젝트 완전 예제
- ✅ 상세한 트러블슈팅 가이드

```bash
# 빠른 시작
npm install
npm run figma:sync  # Figma → 코드 자동 변환
```
